package com.stringing.socketduplexing.message.manager;
...
public class MessageHandler {
     ...
     * @param message 消息内容
     */
    public static void sendMessage(CopyOnWriteArrayList<String> clients, String message) throws NullPointerException{
        if(sendQueue == null)
